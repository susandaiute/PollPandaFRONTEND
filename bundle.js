...
/***/ function(module, exports, __webpack_require__) {
	...
	var answer = __webpack_require__(27);
	var displayQuestions = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexSuccess = __webpack_require__(6);
	var displayQuestions = __webpack_require__(7);
	...
	var updatePassword = function updatePassword(updateSuccess, failure, data) {
	  console.log(app);
	  var form = {
	    "passwords": {
	...
	var answerPoll = function answerPoll(success, failure, data) {
	  $.ajax({
	    method: 'POST',
	    url: app.api + '/answers',
	    data: data,
	...
	var submitQuestion = function submitQuestion(success, failure, data) {
	  $.ajax({
	    method: 'POST',
	...
	var index = function index(indexSuccess, fail) {
	  $.ajax({
	    method: 'GET',
	    url: app.api + '/questions',
	    headers: {
	...
	var updateQuestion = function updateQuestion(updateSuccess, failure, id, data) {
	  $.ajax({
	    method: 'PATCH',
	    url: app.api + '/questions/' + id,
	    data: data,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayQuestions = function displayQuestions(questions) {
	  var questionListingTemplate = __webpack_require__(7);
	  $('.contentGet').html('');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n <div>\n   <p><strong>Question: "
	    ...
	    + "</strong></p>\n   <p>Answer 1: "
	    + alias4(((helper = (helper = helpers.answer1 || (depth0 != null ? depth0.answer1 : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"answer1","hash":{},"data":data}) : helper)))
	    + "</p>\n   <p>Answer 2: "
	    + alias4(((helper = (helper = helpers.answer2 || (depth0 != null ? depth0.answer2 : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"answer2","hash":{},"data":data}) : helper)))
	    + "</p>\n   <p>Answer 3: "
	    + alias4(((helper = (helper = helpers.answer3 || (depth0 != null ? depth0.answer3 : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"answer3","hash":{},"data":data}) : helper)))
	  ...
	  return "<div class='all-questions'>\n"
	    ...
	    + "    <div class=\"updateStatusArea\"></div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var checkAnswerOne = function checkAnswerOne() {
	  answer = $("input[name=worms]:checked");
	  console.log('this is answer' + answer);
	  return answer;
	};

	var checkAnswerTwo = function checkAnswerTwo() {
	  answer = $("input[name=ketchup]:checked").id;
	  return answer;
	};

	var checkAnswerThree = function checkAnswerThree() {
	...
	module.exports = {
	  checkAnswerOne: checkAnswerOne,
	  checkAnswerTwo: checkAnswerTwo,
	  checkAnswerThree: checkAnswerThree,
	  displayResultsThree: displayResultsThree,
	  displayResultsTwo: displayResultsTwo,
	  displayResultsOne: displayResultsOne
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
